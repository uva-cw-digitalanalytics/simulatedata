...
The interface to simulate and download data for A/B test report. Live [here](https://simulatedata2.streamlit.app/).
...
**Note:** The data generation is completely random. Each time you click **Download**, a **new dataset** will be generated. Make sure to **save your dataset locally** once you download it.
